...
//
//   AddAnswers(this.token, this.categoryId, this.subCategoryId,this.productId,this.productName,this.productDescription,this.image,this.storeId);
//
//   @override
//   State<StatefulWidget> createState() {
//     // TODO: implement createState
//     return AddAnswersState(token,categoryId,subCategoryId,productId,productName,productDescription,image,storeId);
//   }
//
// }
// class AddAnswersState extends State<AddAnswers>{
//   var cards = <Card>[];
...
//   AddAnswersState(this.token, this.categoryId, this.subCategoryId,this.productId,this.productName,this.productDescription,this.image,this.storeId);
