...
class _DirectionMapScreenState extends State<Location> {
  ...
  _getAddress() async {
    try {
      ...
      setState(() {
        ...
        print(place.subThoroughfare.toString());
        print(place.position.toString());
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ClipOval(
                        child: Material(
                          color: color3, // button color
                          child: InkWell(
                            splashColor: color3, // inkwell color
                            child: SizedBox(
                              width: 50,
                              height: 50,
                              child: Icon(Icons.add, size: 30, color: color1,),
                            ),
                            onTap: () {
                              mapController.animateCamera(
                                CameraUpdate.zoomIn(),
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            child: SizedBox(
                              width: 50,
                              height: 50,
                              child: Icon(Icons.remove, size: 30, color: color1,),
                            ),
                            onTap: () {
                              mapController.animateCamera(
                  ...
                  child: Padding(
                    ...
                    child: ClipOval(
                      child: Material(
                        color: color3, // button color
                        child: InkWell(
                          splashColor: color1, // inkwell color
                          child: SizedBox(
                            width: 56,
                            height: 56,
                    ...
                    child: ClipOval(
                      child: Material(
                        ...
                        child:  FloatingActionButton(
                          ...
                          child: const Icon(Icons.map, size: 36.0, color: color3,),
                        ),
                      ),
                    ),
                  ),
